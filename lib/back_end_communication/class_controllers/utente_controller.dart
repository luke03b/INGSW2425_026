...
class UtenteController {
  static Future<int> inviaUtente(UtenteDto utente) async {
    final url = UrlBuilder.createUrl(UrlBuilder.PROTOCOL_HTTP, UrlBuilder.INDIRIZZO_IN_USO, port: UrlBuilder.PORTA_SPRINGBOOT, UrlBuilder.ENDPOINT_UTENTI);
  ...
  static Future<http.Response> chiamataHTTPRecuperaUtenteBySub(String sub) async{
    final url = UrlBuilder.createUrl(UrlBuilder.PROTOCOL_HTTP, UrlBuilder.INDIRIZZO_IN_USO, port: UrlBuilder.PORTA_SPRINGBOOT, UrlBuilder.ENDPOINT_UTENTI, queryParams: {'sub': sub});
